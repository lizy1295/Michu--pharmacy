...
export default function CategoriesPage() {
  const [categories, setCategories] = useState<{ id: number; name: string; slug: string; productCount: number; status: string }[]>([]);
              ...
              <tbody className="divide-y divide-slate-100">
                {filtered.map((category) => (
                  <tr key={category.id} className="hover:bg-slate-50/60 transition">
                    ...
                    <td className="py-3.5 px-4 font-bold text-slate-700">{category.productCount ?? 0} items</td>
                    <td className="py-3.5 px-4">
